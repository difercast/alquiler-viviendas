...
En primer lugar se realizará el análisis de la variable `HH060`, correspondiente al valor que pagan las familias por el alquiler de una vivienda. Como se revisó anteriormente, existen dos categorías de régimen de tenecia que se analizarán: El alquiler a precio del mercado y el alquiler a precio inferior al del mercado. 

Presentamos a continuación la distribución de la variable `HH060` a través de las dos categorias de regimen de tenencia mediante gráficos de cajas.
